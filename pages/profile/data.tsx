...
export default function Data() {
    ...
    return(
        <>
        <div style={{display: "flex", marginLeft: "5%", marginBottom: "7%", position: "absolute", zIndex: "1", outline: "solid 1px lightgray", padding: "1%", borderRadius: "8px", backdropFilter: "blur(100px)", filter: "opacity(1)", background: "rgba(0, 0, 0, 0.281)", fontSize: "13px", gap: "10px", color: "", marginTop: "-30%" }}>
