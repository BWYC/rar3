  ...
  return (
    <>
      <div className="dex-container">
        <Head>
          <title>dex - RareBay | DEX1</title>
          <meta property="og:title" content="dex - RareBay | DEX1" />
        </Head>
          ...
          <div className="dex-container02">
            <div className="dex-container03">
              <div className="dex-container04">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="dex-link01"
                >
                  SELL
                </a>
                <svg viewBox="0 0 1024 1024" className="dex-icon04">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="dex-link02"
                >
                  CREATE
                </a>
              </div>
              <header data-thq="thq-navbar" className="dex-navbar-interactive">
                <div data-thq="thq-navbar-nav" className="dex-desktop-menu">
                  <div className="dex-container05">
                    <Search rootClassName="search-root-class-name13"></Search>
                  </div>
                  <div className="dex-buttons">
                    <button className="button">CONNECT</button>
                  </div>
                </div>
                <div data-thq="thq-burger-menu" className="dex-burger-menu">
                ...
                <Search rootClassName="search-root-class-name12"></Search>
                <div data-thq="thq-mobile-menu" className="dex-mobile-menu">
                  <div className="dex-nav">
                    <div className="dex-top">
                      <div data-thq="thq-close-menu" className="dex-close-menu">
                        <svg viewBox="0 0 1024 1024" className="dex-icon08">
                    ...
                    <div className="dex-container06">
                      ...
                      <div className="dex-container08"></div>
                      <div className="dex-container09">
                          ...
                          <a className="dex-link05">
                            <div className="dex-container11">
                              <div className="dex-container12">
                                ...
                                <span className="dex-text01">DEX</span>
                              </div>
                            </div>
                          </a>
                        </Link>
                        <div className="dex-container13">
                          <div className="dex-container14">
                            <svg viewBox="0 0 1024 1024" className="dex-icon12">
                          ...
                          <a className="dex-link06">
                            <div className="dex-container15">
                              <div className="dex-container16">
                                ...
                                <span className="dex-text03">portfolio</span>
                              </div>
                            </div>
                          </a>
                        </Link>
                          ...
                          <a className="dex-link07">
                            <div className="dex-container17">
                              <div className="dex-container18">
                                ...
                                <span className="dex-text04">SATS</span>
                              </div>
                            </div>
                          </a>
                        </Link>
                          ...
                          <a className="dex-link08">
                            <div className="dex-container19">
                              <div className="dex-container20">
                                ...
                                <span className="dex-text05">MINTS</span>
                              </div>
                            </div>
                          </a>
                        </Link>
                          ...
                          <a className="dex-link09">
                            <div className="dex-container23">
                              <div className="dex-container24">
                                <svg
                                  viewBox="0 0 1024 1024"
                                  className="dex-icon20"
                                >
                                  <path d="M768 554q70 0 120 51t50 121-50 120-120 50-120-50-50-120 50-121 120-51zM768 640q-34 0-60 26t-26 60 26 59 60 25 60-25 26-59-26-60-60-26zM512 128q70 0 120 50t50 120-50 121-120 51-120-51-50-121 50-120 120-50zM512 214q-34 0-60 25t-26 59 26 60 60 26 60-26 26-60-26-59-60-25zM256 554q70 0 120 51t50 121-50 120-120 50-120-50-50-120 50-121 120-51zM256 640q-34 0-60 26t-26 60 26 59 60 25 60-25 26-59-26-60-60-26z"></path>
                                </svg>
                                <span className="dex-text07">DEX</span>
                              </div>
                            </div>
                          </a>
                        </Link>
                          ...
                          <a className="dex-link10">
                            <div className="dex-container25">
                              <div className="dex-container26">
                                <svg
                                  viewBox="0 0 1024 1024"
                                  className="dex-icon22"
                                >
                                  <path d="M598 234q0-44 31-75t75-31 75 31 31 75-31 76-75 32-75-32-31-76zM370 512q-24 0-50-16-8-6-32-16l138-138-42-44q-64-64-170-64v-106q82 0 134 19t100 67l274 272q-12 8-18 10-26 16-50 16-22 0-48-16-44-26-94-26t-94 26q-26 16-48 16zM938 704q-46 0-92-28-22-14-50-14-26 0-48 14-46 28-94 28-46 0-92-28-22-14-50-14-26 0-48 14-46 28-94 28-46 0-92-28-22-14-50-14-26 0-48 14-46 28-94 28v-86q26 0 48-14 46-28 94-28 46 0 92 28 22 14 50 14 26 0 48-14 46-28 94-28 46 0 92 28 22 14 50 14 26 0 48-14 46-28 94-28 46 0 92 28 22 14 50 14v86zM938 896q-46 0-92-28-22-14-50-14-26 0-48 14-46 28-94 28-46 0-92-28-22-14-50-14-26 0-48 14-46 28-94 28t-94-28q-22-14-48-14-28 0-50 14-46 28-92 28v-86q26 0 48-14 46-28 94-28 46 0 92 28 22 14 50 14 26 0 48-14 46-28 94-28t94 28q22 14 48 14 28 0 50-14 46-28 92-28 48 0 94 28 22 14 48 14v86z"></path>
                                </svg>
                                <span className="dex-text08">POOLS</span>
                              </div>
                            </div>
                          </a>
                        </Link>
                          ...
                          <a className="dex-link11">
                            <div className="dex-container27">
                              <div className="dex-container28">
                                <svg
                                  viewBox="0 0 1024 1024"
                                  className="dex-icon24"
                                >
                                  <path d="M864 0h-768c-52.8 0-96 43.2-96 96v832c0 52.8 43.2 96 96 96h768c52.8 0 96-43.2 96-96v-832c0-52.8-43.2-96-96-96zM832 896h-704v-768h704v768zM256 576h448v64h-448zM256 704h448v64h-448zM320 288c0-53.019 42.981-96 96-96s96 42.981 96 96c0 53.019-42.981 96-96 96s-96-42.981-96-96zM480 384h-128c-52.8 0-96 28.8-96 64v64h320v-64c0-35.2-43.2-64-96-64z"></path>
                                </svg>
                                <span className="dex-text09">portfolio</span>
                              </div>
                            </div>
                          </a>
                        </Link>
                      </div>
                      <div className="dex-container29"></div>
                      <div id="connecting" className="dex-container30"></div>
                    </div>
                  </div>
                </div>
                <div id="connect" className="dex-container31">
                  <a
                    href="https://#"
                    target="_blank"
                    rel="noreferrer noopener"
                    className="dex-link12"
                  >
                    <svg viewBox="0 0 1024 1024" className="dex-icon26">
                  ...
                  <div id="connecting" className="dex-container32"></div>
                </div>
              </header>
            </div>
            <div className="dex-container33">
              <div className="dex-col">
                ...
                <div className="dex-container35"></div>
              </div>
              <div className="dex-row"></div>
            </div>
          </div>
        </div>
      ...
      <style jsx>
        {`
          ...
          .dex-container11:hover {
            color: var(--dl-color-gray-black);
            background: aliceblue;
          }
          .dex-container11:active {
            background: #252525;
          }
          .dex-container12 {
            flex: 0 0 auto;
          ...
          .dex-container13:hover {
            color: var(--dl-color-gray-black);
            background: aliceblue;
          }
          .dex-container13:active {
            background: #252525;
          }
          .dex-container14 {
            flex: 0 0 auto;
          ...
          .dex-container15:hover {
            color: var(--dl-color-gray-black);
            background: aliceblue;
          }
          .dex-container15:active {
            background: #252525;
          }
          .dex-container16 {
            flex: 0 0 auto;
          ...
          .dex-container19:hover {
            color: var(--dl-color-gray-black);
            background: aliceblue;
          }
          .dex-container19:active {
            background: #252525;
          }
          .dex-container20 {
            flex: 0 0 auto;
          ...
          .dex-container23:hover {
            color: var(--dl-color-gray-black);
            background: aliceblue;
          }
          .dex-container23:active {
            background: #252525;
          }
          .dex-container24 {
            flex: 0 0 auto;
          ...
          .dex-container27:hover {
            color: var(--dl-color-gray-black);
            background: aliceblue;
          }
          .dex-container27:active {
            background: #252525;
          }
          .dex-container28 {
            flex: 0 0 auto;
