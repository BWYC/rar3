  ...
  return (
    <>
      <div className={`nav-container ${props.rootClassName} `}>
        ...
        <svg viewBox="0 0 950.8571428571428 1024" className="nav-icon2">
        ...
        <span className="nav-text1">{props.text3}</span>
        <svg viewBox="0 0 1024 1024" className="nav-icon4">
        ...
        <span className="nav-text2">{props.text4}</span>
      </div>
      <style jsx>
        {`
          .nav-container {
